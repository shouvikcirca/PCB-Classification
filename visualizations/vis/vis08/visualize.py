...
a.plot(fold1_1, label='resnext50_32x4d with Cutmix')
b.plot(fold1_2, label = 'resnext50_32x4d without Cutmix')
c.plot(fold2_1, label='resnext50_32x4d with Cutmix')
d.plot(fold2_2, label = 'resnext50_32x4d without Cutmix')
e.plot(fold3_1, label='resnext50_32x4d with Cutmix')
f.plot(fold3_2, label = 'resnext50_32x4d without Cutmix')
