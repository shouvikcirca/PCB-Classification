...
a.plot(fold1_2, label='lf = 100000')
a.plot(fold1_3, label='lf = 10000')
a.plot(fold1_4, label='lf = 1000')
a.plot(fold1_5, label='lf = 100')
...
b.plot(fold2_2, label='lf = 100000')
b.plot(fold2_3, label='lf = 10000')
b.plot(fold2_4, label='lf = 1000')
b.plot(fold2_5, label='lf = 100')

b.set_xlabel('epochs')
b.set_ylabel('Validation loss')

c.plot(fold3_1, label='resnext50_32x4d')
c.plot(fold3_2, label='lf = 100000')
c.plot(fold3_3, label='lf = 10000')
c.plot(fold3_4, label='lf = 1000')
c.plot(fold3_5, label='lf = 100')
