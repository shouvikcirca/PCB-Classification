...
a.plot(fold1_2, label='lf = 2')
a.plot(fold1_3, label='lf = 3')
a.plot(fold1_4, label='lf = 4')
a.plot(fold1_5, label='lf = 5')
...
b.plot(fold2_2, label='lf = 2')
b.plot(fold2_3, label='lf = 3')
b.plot(fold2_4, label='lf = 4')
b.plot(fold2_5, label='lf = 5')

b.set_xlabel('epochs')
b.set_ylabel('Validation loss')

c.plot(fold3_1, label='resnext50_32x4d')
c.plot(fold3_2, label='lf = 2')
c.plot(fold3_3, label='lf = 3')
c.plot(fold3_4, label='lf = 4')
c.plot(fold3_5, label='lf = 5')
