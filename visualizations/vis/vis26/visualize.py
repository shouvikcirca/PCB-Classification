...
a.plot(fold1_1, label='Batch size = 64')
b.plot(fold1_2, label = 'Batch size = 86')
c.plot(fold2_1, label='Batch size = 64')
d.plot(fold2_2, label = 'Batch size = 86')
e.plot(fold3_1, label='Batch size = 64')
f.plot(fold3_2, label = 'Batch size = 86')
