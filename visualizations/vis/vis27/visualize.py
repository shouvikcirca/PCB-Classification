...
a.plot(fold1_1, label='Adam')
b.plot(fold1_2, label = 'Amsgrad')
c.plot(fold2_1, label='Adam')
d.plot(fold2_2, label = 'Amsgrad')
e.plot(fold3_1, label='Adam')
f.plot(fold3_2, label = 'Amsgrad')
