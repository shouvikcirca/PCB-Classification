...
b.plot(fold1_2, label = 'L2 Constrained_Softmax')
c.plot(fold2_1, label='resnext50_32x4d')
d.plot(fold2_2, label = 'L2 Constrained_Softmax')
e.plot(fold3_1, label='resnext50_32x4d')
f.plot(fold3_2, label = 'L2 Constrained_Softmax')
