...
if f == '1':
	trainmean = [0.5050, 0.5360, 0.5626]
	trainstd = [0.2143, 0.2161, 0.1965]
elif f == '2':
	trainmean = [0.5087, 0.5369, 0.5626]
	trainstd = [0.2120, 0.2161, 0.1965]
elif f == '3':
	trainmean = [0.5075, 0.5366, 0.5626]
	trainstd = [0.2121, 0.2163, 0.1965]
##########################################################################################
...
#model.load_state_dict(torch.load('resnext_prelu.pth'))
